...
void CTestBlueLightExp::SetController(CEpuck* pc_epuck)
{
	...
	CController* pcController = new CPythonBlueLightController(pchTemp, pc_epuck, "python/bluelight_controller.py");
...
{
	double px, py, ptheta;
	CPythonControllerBase::ReadInitPose("python/bluelight_controller.py", px, py, ptheta);
	char label[100];
